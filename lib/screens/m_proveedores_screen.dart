...
class MProveedoresScreen extends StatefulWidget {

  const MProveedoresScreen({ super.key });

  @override
  State<MProveedoresScreen> createState() => _MProveedoresScreenState();
}

class _MProveedoresScreenState extends State<MProveedoresScreen> {

var tipoBase = 'proveedor';
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          MaterialButton(
            ...
            child: Text('Agregar',style: TextStyle(color: Colors.black54, fontSize: 18,fontWeight: FontWeight.bold,)))
        ],
      ),
    );  
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
          floatingActionButton: FloatingActionButton(
            ...
            backgroundColor: Colors.deepOrangeAccent,//color de fondo del boton agregar
            ...
            children: [
                  Expanded(child: 
                    StreamBuilder<QuerySnapshot>(
                        stream:  firestoreService.getProveedorStream(),
